                    ...
                    <div className="row mt-4 support">
                        ...
                        <div className="col-12 col-md-6 align-self-center social">
                            <div className="text-center">
                                <a className="btn" href="http://google.com/+"><i className="fa fa-google-plus" aria-hidden="true" /></a>
                                <a className="btn" href="http://www.facebook.com/profile.php?id="><i className="fa fa-facebook" /></a>
                                <a className="btn" href="http://www.linkedin.com/in/"><i className="fa fa-linkedin" /></a>
                                <a className="btn" href="http://twitter.com/"><i className="fa fa-twitter" aria-hidden="true" /></a>
                                <a className="btn" href="http://youtube.com/"><i className="fa fa-youtube" /></a>
                                <a className="btn" href="mailto:"><i className="fa fa-envelope-o" /></a>
                            </div>
                        </div>
                    </div>
                </div>
