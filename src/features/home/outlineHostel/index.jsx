...
OutlineHostel.propTypes = {

};

function OutlineHostel(props) {
    return (
            ...
            <div className="row row-content align-self-center">
                ...
                <div className="col col-md align-self-center">
                    <p>Among going manor who did. Do ye is celebrated it sympathize considered. May ecstatic did
                        surprise
                        elegance the ignorant age. Own her miss cold last. It so numerous if he outlived disposal. How
                        but
                        sons mrs lady when. Her especially are unpleasant out.</p>
                </div>
            </div>
                ...
                <div className="infor">
                    ...
                    <div className="content">
                        ...
                        <div className="col-12 text-center">
                            <a href="#" className="btn">View room</a>
                        </div>
                    </div>
                </div>
                <div className="infor">
