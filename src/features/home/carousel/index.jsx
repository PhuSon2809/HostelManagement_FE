        ...
        <div id="myCarousel" className="carousel" data-ride="carousel">
            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img src="./images/slide1.webp" alt="First slide" className="d-block w-100" />
                ...
                <div className="carousel-item">
                    <img src="./images/slide2.webp" alt="Second slide" className="d-block w-100" />
                    <div className="carousel-caption d-none d-md-block">
                        <h1>Dark Hostel</h1>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                        <a href="#" className="btn">Booking</a>
                ...
                <div className="carousel-item">
                    <img src="./images/slide3.webp" alt="Third slide" className="d-block w-100" />
                    <div className="carousel-caption d-none d-md-block">
                        <h1>Pool Hostel</h1>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                        <a href="#" className="btn">Booking</a>
