                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <input class="form-control" type="email" name="email" placeholder="Enter your email" onChange={handleChange} />
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <input class="form-control" type="text" name="phone" placeholder="Enter you phone" onChange={handleChange} />
